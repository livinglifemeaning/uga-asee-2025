...
class OuttakeSystem:
    ...
    def __init__(self, pin, channel_id, i2c, pca):
        self.i2c = i2c
        self.pca = pca

        self.outtake = Motor(channel_id=channel_id, i2c=i2c, pca=pca)
        self.gate = Servo(pin=pin, initial_angle=0.0, full_rotation_time=1.3)
